...
import { ArrowDown, Check, ChevronDown, CookingPot, Droplets, HeartHandshake, Leaf, MapPin, MapPinned, PackageCheck, Phone, ShieldCheck, ShoppingBag, Sprout, Truck, Wheat } from 'lucide-react'
    ...
    <footer className="footer">
      ...
      <div className="shell footer-main">
        ...
        <nav className="footer-nav" aria-label="Footer navigation">
          ...
          <div><b>Connect</b><a href={`tel:+91${contact.phone}`}>+91 {contact.phone}</a><a href={`mailto:${contact.email}`}>{contact.email}</a><a href="#contact">{contact.instagram}</a><button onClick={() => openWhatsApp(generalWhatsAppMessage)}>WhatsApp KS Farms</button></div>
